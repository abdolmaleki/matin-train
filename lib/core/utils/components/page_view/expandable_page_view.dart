...
class CustomExpandablePageView extends StatefulWidget {
  ...
  ///
  /// By default (false) [CustomExpandablePageView] will resize to the size of it's
  ...
  /// [CustomExpandablePageView] size animation. This can lead to a behaviour
  /// when after changing the page, [CustomExpandablePageView] will first shrink to 0.0
  /// and then animate to the size of the page.
  ///
  /// For example: If there is certainty that most pages displayed by [CustomExpandablePageView]
  ...
  const CustomExpandablePageView.builder({
...
class _CustomExpandablePageViewState extends State<CustomExpandablePageView> {
  ...
  @override
  void didUpdateWidget(covariant CustomExpandablePageView oldWidget) {
  ...
  bool _shouldReinitializeHeights(CustomExpandablePageView oldWidget) {
