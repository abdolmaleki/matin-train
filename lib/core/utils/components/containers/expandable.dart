...
class ExpandableThemeData {
  ...
  /// If true, the header of [CustomExpandablePanel] can be clicked by the user to expand or collapse.
  final bool? tapHeaderToExpand;

  /// If true, the body of [CustomExpandablePanel] can be clicked by the user to expand.
  final bool? tapBodyToExpand;

  /// If true, the body of [CustomExpandablePanel] can be clicked by the user to collapse.
  final bool? tapBodyToCollapse;

  /// If true, an icon is shown in the header of [CustomExpandablePanel].
  final bool? hasIcon;
...
/// Determines the placement of the expand/collapse icon in [CustomExpandablePanel]
...
class ExpandableIcon extends StatefulWidget {
  ...
  @override
  State<ExpandableIcon> createState() =>
      _ExpandableIconState();
}
...
class ScrollOnExpand extends StatefulWidget {
  ...
  @override
  State<ScrollOnExpand> createState() =>
      _ScrollOnExpandState();
