...
class _CustomerService implements CustomerService {
  ...
  @override
  Future<ApiResponse<CustomerResponse>> getCustomers() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<CustomerResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = ApiResponse<CustomerResponse>.fromJson(
      _result.data!,
