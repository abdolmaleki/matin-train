...
import 'package:team_project/features/feature_section/presentation/widgets/tab_bar.dart';
...
class _SplashPageState extends State<SplashPage> {
  ...
  void _handleState(SplashState state) {
    if (state is UserInfoLoaded) {
      print("Its Ok");
      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>TabBarPage()));
